====================
Horizontal ResNet Paddle
====================

Introduction
------------

Horizontal ResNet Paddle model is a model obtained by building the classic model ResNet proposed in the paper "Deep Residual Learning for Image Recognition" on the horizontal federation system, 
and is implemented based on the deep learning framework PaddlePaddle.
...
**model_info**:
    - **name**: ``str`` Model name, should be `horizontal_resnet_paddle`.
    - **config**:
...
**train_info**:
    ...
    - **params**:
        ...
        - **optimizer_config**: Support optimizers and their parameters defined in PaddlePaddle or registered by user. For example:
            - **SGD**:
                - **learning_rate**: ``float`` Optimizer learning rate. If using lr scheduler, this value should not be ignored.
                - **weight_decay**: ``float`` Optimizer weight decay.
        - **lr_scheduler_config**: Support lr_scheduler and their parameters defined in PaddlePaddle or registered by user. For example:
            - **StepDecay**:
