...
if [ ! -d "${PROJECT_HOME}/dataset/breast_cancer_wisconsin_horizontal/3party" ]; then
  if [ ! -f "${PROJECT_HOME}/python/xfl.py" ]; then
    python "${PROJECT_HOME}/common/dataset/breast_cancer_wisconsin.py" --mode "horizontal" --splits 3 --party "1" "2" "3"
  else
    python "${PROJECT_HOME}/python/common/dataset/breast_cancer_wisconsin.py" --mode "horizontal" --splits 3 --party "1" "2" "3"
  fi
fi
